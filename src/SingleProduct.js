...
const SingleProduct = () => {
  const { getsingleProduct, isSingleLoading, singleProducts } = useContext(AppContext)
        ...
        <div className="grid grid-two-column">
          ...
          <div className="product-data">
            ...
            <div className="product-data-info">
              <p>Available:<span>{stock > 0 ? "InStocks" : "Not Available"}</span></p>
              <p>
                Id: {id}
              </p>
              <p>
